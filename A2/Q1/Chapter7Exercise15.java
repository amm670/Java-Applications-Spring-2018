...
public class Chapter7Exercise15 {
	
	static final int SIZE = 10;  //creates the size of 10 numbers for the user to put in
    ...
    public static void main(String[] args) { 
        ...
        printArray(eliminateDuplicates(numbers), 10);  // using 

    }

    public static int[] eliminateDuplicates(int[] list) {  // given method 
